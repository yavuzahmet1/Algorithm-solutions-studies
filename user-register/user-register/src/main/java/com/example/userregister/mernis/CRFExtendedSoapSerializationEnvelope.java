...
class CRFSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class CRFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CRFDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new CRFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CRFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CRFDateTimeConverter dateTimeConverter = new CRFStandardDateTimeConverter();

    public CRFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CRFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CRFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CRFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CRFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CRFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
