...
public class CRFKPSPublicSoap
{
    ...
    public CRFKPSPublicSoap(){}

    public CRFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CRFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CRFExtendedSoapSerializationEnvelope envelope= new CRFExtendedSoapSerializationEnvelope(CRFExtendedSoapSerializationEnvelope.VER11);
